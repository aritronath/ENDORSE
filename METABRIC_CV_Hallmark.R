...
# 50 rep 10-fold CV
MB_H_Model_cv_results <- list()

MB_H_Model_cv_results <- foreach (i=1:50) %dopar% {
  sink("LOG_MB_hCV.txt", append=TRUE)
...
save(MB_H_Model_cv_results, file="./../Output/MB_H_Model_cv_results.RData")
